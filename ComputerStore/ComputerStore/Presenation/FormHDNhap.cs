    ...
    public class FormHDNhap
    {
        public void Nhap(int x, int y, ConsoleColor background_color, ConsoleColor text_color)
        {
            do
            {
                ...
                while (true)
                {
                    ...
                    IO.Clear(x + 3, y + 7, 60, ConsoleColor.Black);
                    HienCT_N(x + 13, y + 10, cthdnhap.LayDS_CTHDNhap(), 5, 0);
                    do
                    {
                ...
                else if (kt.Key == ConsoleKey.Enter)
                {
                    ...
                    hdnhap.ThemHDNhap(hdn);
                    Hien(x + 13, y + 10, hdnhap.LayDSHDNhap(), 5, 1);
                }
            } while (true);
        }
                ...
                do
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            mahdn = CongCu.ChuanHoaMa(mahdn);
                            List<CTHDNhap> list = cthdnhap.LayCTHDNhap(new CTHDNhap(mahdn, null, 0, 0, 0));
                            HienCT_N(x + 13, y + 8, list, 5, 1);
                        }
                    }
                } while (mahdn == "" || hdnBLL.KT_MaHDN(CongCu.ChuanHoaMa(mahdn)) == false);
            } while (true);
        ...
        public void HienCT_N(int xx, int yy, List<CTHDNhap> list, int n, int type)
        {
            ...
            do
            {
                ...
                IO.Writexy("┌──────────────┬────────────────┬───────────────┬───────────────┬───────────────────┐", x, y + 1);
                IO.Writexy("│  Mã HD nhập  │  Mã máy tính   │   Số lượng    │    Đơn giá    │    Thành tiền     │", x, y + 2);
                IO.Writexy("├──────────────┼────────────────┼───────────────┼───────────────┼───────────────────┤", x, y + 3);
                y += 4;
                for (int i = head; i < final; i++)
                {
