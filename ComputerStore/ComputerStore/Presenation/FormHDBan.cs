    ...
    public class FormHDBan
    {
        public void Nhap(int x, int y, ConsoleColor background_color, ConsoleColor text_color)
        {
            do
            {
                ...
                do
                {
                    hdb.maNV = IO.ReadString(x + 16, y + 3);
                    if (hdb.maNV == null)
                    {
                ...
                do
                {
                    hdb.maKH = IO.ReadString(x + 44, y + 3);
                    if (hdb.maKH == null)
                    {
                        IO.Clear(x + 3, y + 7, 60, ConsoleColor.Black);
                ...
                do
                {
                    hdb.maMT = IO.ReadString(x + 73, y + 3);
                    if (hdb.maMT == null)
                    {
                        IO.Clear(x + 3, y + 7, 60, ConsoleColor.Black);
